  ...
  useEffect(() => {
    const filteredFor = courseData.filter((item) => {
      if (filterFor.length <= 0) {
        ...
        return item.level === filterFor[0] || item.level === filterFor[1];
      }
    });
    ...
    <article className="allCoursesArea__list">
      <div className="allCoursesArea__list__filter">
        ...
        <input
          ...
          value="coding"
        />
        <label className="button-label coding-label" htmlFor="coding-button">
          <p>coding</p>
        </label>
        <input
          className="hidden"
          ...
          value="design"
        />
        <label className="button-label design-label" htmlFor="design-button">
          <p>design</p>
        </label>
        <input
          className="hidden"
          ...
          value="data"
        />
        <label className="button-label data-label" htmlFor="data-button">
          <p>data</p>
        </label>
        {/* ---------------------- */}
        <input
          ...
          value="expert"
        />
        <label className="button-label expert-label" htmlFor="expert-button">
          <p>expert</p>
        </label>
        <input
          className="hidden"
