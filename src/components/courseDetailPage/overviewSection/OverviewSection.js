        ...
        <section className="overviewSection" id="overviewSection">
            <div className="wrap">
                <article className="overviewSection__textarea">
                    ...
                    <p>Unser MicroCamp für {subTheme} bietet dir eine intensive {Number(duration.slice(0, 1)) > 10 ? Number(duration.slice(0, 1)) : Number(duration.slice(0, 2))}-wöchige Lernerfahrung, die dich auf's nächste Level bringt!</p>
